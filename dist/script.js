...
window.addEventListener('load', function () {
  ...
  Object(_modules_showMore__WEBPACK_IMPORTED_MODULE_3__["default"])('.button-styles', '.styles-2');
});
...
/* harmony import */ var _helpers_postRequest__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ../helpers/postRequest */ "./src/js/helpers/postRequest.js");
...
var forms = function forms() {
  ...
  forms.forEach(function (element, i) {
    var z = element.querySelector('input[type="file"]');

    if (z) {
      z.addEventListener('change', function () {
        if (z.value) {
          var oldElem = element.querySelector('.file_upload div');
          oldElem.textContent = z.files[0].name.slice(0, 14);
        } else {
          var _oldElem = element.querySelector('.file_upload div');

          _oldElem.textContent = 'Файл не выбран';
        }
      });
    }

    element.addEventListener('submit', function _callee(e) {
      var status, statusText, formData, a;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              statusText = document.createTextNode(message.loading);
              ...
              _context.prev = 8;
              _context.next = 11;
              return regeneratorRuntime.awrap(Object(_helpers_postRequest__WEBPACK_IMPORTED_MODULE_6__["postRequest"])('assets/server.php', formData));
...
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! regenerator-runtime/runtime */ "./node_modules/regenerator-runtime/runtime.js");
/* harmony import */ var regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(regenerator_runtime_runtime__WEBPACK_IMPORTED_MODULE_2__);
/* harmony import */ var _helpers_postRequest__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../helpers/postRequest */ "./src/js/helpers/postRequest.js");





var showMore = function showMore(element, content) {
  var button = document.querySelector(element),
      elements = document.querySelectorAll(content); // button.addEventListener('click', () => {
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.prev = 0;
            _context.next = 3;
            return regeneratorRuntime.awrap(Object(_helpers_postRequest__WEBPACK_IMPORTED_MODULE_3__["getRequest"])('http://localhost:3000/styles'));
...
var slider = function slider(wrapper, _slider, sliderItem, slidetoShow, delay) {
  ...
  startSlideShow();
  slideWrapper.addEventListener('mouseover', function (e) {
